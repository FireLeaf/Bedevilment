...
TEST_CASE_METHOD(EntityManagerFixture, "TestComponentConstruction") {
  auto e = em.create();
  auto p = e.assign<Position>(1.0f, 2.0f);
...
TEST_CASE_METHOD(EntityManagerFixture, "TestUnpack") {
  Entity e = em.create();
  auto p = e.assign<Position>(1.0f, 2.0f);
  auto d = e.assign<Direction>(3.0f, 4.0f);
...
TEST_CASE_METHOD(EntityManagerFixture, "TestComponentRemovedEvent") {
  ...
  Entity e = em.create();
  ComponentHandle<Direction> p = e.assign<Direction>(1.0f, 2.0f);
  e.remove<Direction>();
...
TEST_CASE_METHOD(EntityManagerFixture, "TestComponentHandleInvalidatedWhenEntityDestroyed") {
  Entity a = em.create();
  ComponentHandle<Position> position = a.assign<Position>(1.0f, 2.0f);
  REQUIRE(position);
...
TEST_CASE_METHOD(EntityManagerFixture, "TestEntityCreateFromCopy") {
  ...
  ComponentHandle<Position> aPosition = a.assign<Position>(1.0f, 2.0f);
...
TEST_CASE_METHOD(EntityManagerFixture, "TestConstComponentsNotInstantiatedTwice") {
  ...
  REQUIRE(b.component<const Position>()->x == 1.0f);
  REQUIRE(b.component<const Position>()->y == 2.0f);
}
...
TEST_CASE_METHOD(EntityManagerFixture, "TestComponentDereference") {
  Entity a = em.create();
  a.assign<Position>(10.0f, 5.0f);
  auto& positionRef = *a.component<Position>();
  REQUIRE(positionRef.x == 10.0f);
  REQUIRE(positionRef.y == 5.0f);
  positionRef.y = 20.0f;
  REQUIRE(a.component<Position>()->y == 20.0f);
}
